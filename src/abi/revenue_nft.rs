...
pub mod functions {
    ...
    impl Exists {
        const METHOD_ID: [u8; 4] = [56u8, 166u8, 153u8, 164u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl Mint {
        const METHOD_ID: [u8; 4] = [41u8, 60u8, 106u8, 58u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl PoolIdOf {
        const METHOD_ID: [u8; 4] = [131u8, 200u8, 172u8, 161u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for PoolIdOf {
        const NAME: &'static str = "poolIdOf";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
    ...
    impl substreams_ethereum::rpc::RPCDecodable<[u8; 32usize]> for PoolIdOf {
    ...
    impl TokenIdOf {
        const METHOD_ID: [u8; 4] = [205u8, 91u8, 251u8, 99u8];
        pub fn decode(
            call: &substreams_ethereum::pb::eth::v2::Call,
        ) -> Result<Self, String> {
            let maybe_data = call.input.get(4..);
    ...
    impl substreams_ethereum::Function for TokenIdOf {
        const NAME: &'static str = "tokenIdOf";
        fn match_call(call: &substreams_ethereum::pb::eth::v2::Call) -> bool {
            Self::match_call(call)
        }
        fn decode(
